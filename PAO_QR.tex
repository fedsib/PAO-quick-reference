...
\begin{center}
  ...
  \vskip.7in
  \emph{\huge Riassunto Programmazione ad Oggetti}
\end{center}
...
\include{classes_and_object} %capitoli 2 e 3
\include{template} %capitolo 4
\include{STL_containers} %capitolo 5
\include{inheritance} %capitolo 6, 7 e 8
\include{Qt} %capitolo 9
\include{Project}
\include{Extra} 
